...
export default function SignUp() {
  ...
  const [formData, setFormData] = useState({
    ...
    password: "",
    confirmPassword: "",
    role: "USER", // Default role (you can change it later if needed)
  });
            ...
            <div>
              ...
              <div className="mt-1">
                <select
                  ...
                  value={formData.role}
                  onChange={handleChange}
                  className="appearance-none block w-full px-3 py-2 border border-neutral-800 rounded-lg bg-neutral-900 text-neutral-200 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500/20"
                >
