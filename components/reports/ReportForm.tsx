...
// // import { useCallback, useState } from "react";
// // // Adjust the import depending on how LocationInput is exported
// // import  LocationInput  from "@/components/reports/LocationInput"; 
// // import crypto from 'crypto';
...
// //           title: data.title,
// //           description: data.description,
// //           specificType: data.reportType,  // Ensure field name consistency
// //         }));
// //         setImage(base64 as string);
// //       }
// //     } catch (error) {
...
// //       {/* Location Input with required props */}
// //       <LocationInput/>
...
// //         className="w-full bg-blue-600 text-white px-4 py-3.5 rounded-xl"
// //       >
// //         {isSubmitting ? "Submitting..." : "Submit Report"}
// //       </button>
// //     </form>
...
// // Define a local union type for report type
// type LocalReportType = "EMERGENCY" | "NON_EMERGENCY";
...
//       const reportData = {
//         reportId: reportId(),
//         type: formData.incidentType, // This should be a string: "EMERGENCY" or "NON_EMERGENCY"
//         specificType: formData.specificType,
//         title: formData.title,
//         description: formData.description,
//         location: formData.location,
